...
public class ConsultationActivity extends BaseActivity implements NLPListener {


    private LinearLayout contentViewCon;
    private Timer timer;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 获取内容布局
        contentViewCon = findViewById(R.id.contentViewCon);
        ...
        BaseActivity.setOnHandlerListener(new BaseActivity.HandlerListener() {
            ...
            public void heandleMessage(Message msg) {
                timer.cancel();
                Intent intent = new Intent(ConsultationActivity.this, SleepActivity.class);
                startActivity(intent);
            }
        });
        ...
        try {
            ...
            if(intentObject.has("answer")){
                ...
                if(answerObject.has("emotion") && answerObject.getString("emotion").equals("default")) {
                    ...
                    // 人问问题
                    new PeopleAskView().peopleAsk(this, intentObject.getString("text"), contentViewCon);
                    // 设置默认滚到到最底部
                    final ScrollView scrollView = findViewById(R.id.sv_co);
                    ...
                    // 机器人回答
                    new RobotAnwserView().answer(this, answerText, contentViewCon);

                    // 设置默认滚到到最底部
                    final ScrollView scrollView1 = findViewById(R.id.sv_co);
            ...
            if(TextUtils.equals("OS8047208306.my_order", intentObject.getString("service"))){
                ...
                if (TextUtils.equals("visit_book", intent)) {
                    timer.cancel();
                    Intent i  = new Intent(ConsultationActivity.this,FaceToNotCardActivity.class);
                    startActivity(i);
